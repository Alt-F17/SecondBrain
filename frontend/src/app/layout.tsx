...
export const metadata: Metadata = {
  title: "Second Brain",
  description: "AI-powered personal memory system with semantic search, voice recording, and vector database storage.",
  keywords: ["memory", "AI", "semantic search", "voice recording", "notes"],
  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        {/* iOS Icons - use correct file naming */}
      ...
      <body
        className={`${jetbrainsMono.variable} ${spaceMono.variable} font-mono antialiased`}
      >
        {children}
      </body>
    </html>
